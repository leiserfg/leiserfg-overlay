...
NB8 X60QiniGuard_0_asds88s9a1;
NI32 cmdCount;
NC8** cmdLine;
NC8** nimEnviron;
NI32 main(NI32 X60Qargc_0_asds88s9a1, char** X60Qargv_0_asds88s9a1, char** X60Qenvp_0_asds88s9a1){
  cmdCount = X60Qargc_0_asds88s9a1;
  cmdLine = ((NC8**)X60Qargv_0_asds88s9a1);
  nimEnviron = ((NC8**)X60Qenvp_0_asds88s9a1);
  {
    {
      if (X60QiniGuard_0_asds88s9a1){
        goto returnLabel_0h1;}
      X60QiniGuard_0_asds88s9a1 = NIM_TRUE;
      X60Qini_0_sysvq0asl();
