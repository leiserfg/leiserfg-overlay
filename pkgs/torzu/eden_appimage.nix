...
let
  pname = "eden-emulator";
  version = "0.2.0";
  sha256 = "sha256-jF81BfOPdSJSCOTQZW9OrX5k4WYlBj/VohjyHw8RAdE=";
  ...
  src = fetchurl {
    ...
    url = "https://nightly.eden-emu.dev/v1777489956.8765b49512/Eden-Linux-8765b49512-steamdeck-clang-pgo.AppImage";
    inherit sha256;
  };
